        ...
        <v-dialog v-model="show" width="80%">
            <v-card>
                ...
                <v-card-subtitle class="mt-1 font-weight-regular">
                    ...
                    <span v-if="order.status == 0" class="grey--text font-italic">En Attente</span>
                    <span v-if="order.status == 1" class="red-text font-italic">Annulée</span>
                    <span v-if="order.status == 2" class="green--text font-italic">Completée</span>
                </v-card-subtitle>
                <v-card-text>
                    <v-container>
                        <v-row no-gutters>
                            <v-col cols="12" md="6">
                                <v-card class="py-2" flat>
                                    <v-card-text>
                                        <p class="display-1 text--primary">Utilisateur</p>
                            ...
                            <v-col cols="12" md="6">
                                <v-card class="py-2" flat>
                                    <v-card-title class="headline">Panier</v-card-title>
                                    <v-card-subtitle>{{ order.content.length }} éléments</v-card-subtitle>
                                    <v-card-text>
                                        <ul>
                                            <li v-for="(product, i) in order.items" :key="i">
