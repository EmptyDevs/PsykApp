        ...
        <v-dialog v-model="show" width="80%">
            <v-card>
                ...
                <v-card-subtitle class="mt-1 font-weight-regular">
                    ...
                    <span v-if="order.status == 1" class="green--text font-italic">Completée</span>
                </v-card-subtitle>
                <v-card-text>
                    <v-container>
                        <v-row no-gutters>
                            ...
                            <v-col cols="12" md="6">
                                <v-card class="py-2" flat v-if="order.content">
                                    ...
                                    <v-card-text>
                                        <ul>
                                            <li
                                                v-for="(product, i) in order.content.items"
                                                :key="i"
                                            >
                ...
                <v-card-actions class="px-4 pb-3">
                    ...
                    <v-btn color="info" :disabled="order.status == 0" @click="updateStatus(0)">
                        <v-icon left>mdi-check</v-icon>Mettre en attente
                    </v-btn>
